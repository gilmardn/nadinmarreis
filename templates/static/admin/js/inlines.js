  ...
  $.fn.formset = function (opts) {
    ...
    const addInlineAddButton = function () {
      if (addButton === null) {
        if ($this.prop('tagName') === 'TR') {
          ...
          $this
            .filter(':last')
            .after('<div class="' + options.addCssClass + '"><a href="#">' + options.addText + '</a></div>');
    ...
    const addInlineDeleteButton = function (row) {
      if (row.is('tr')) {
        ...
        row
          .children(':last')
          .append('<div><a class="' + options.deleteCssClass + '" href="#">' + options.deleteText + '</a></div>');
        ...
        row
          .children(':first')
          .append('<span><a class="' + options.deleteCssClass + '" href="#">' + options.deleteText + '</a></span>');
      }
    ...
    $this
      .filter('.' + options.formCssClass + ':not(.has_original):not(.' + options.emptyCssClass + ')')
      .each(function () {
